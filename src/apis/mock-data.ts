export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'AntonioVu MERN Stack Board',
    description: 'Pro MERN stack Course',
    type: 'public' as BoardTypes, // 'private'
    ownerIds: [], // users have Admin role of board
    memberIds: [], // users are normal member of board
    columnOrderIds: ['column-id-01', 'column-id-02', 'column-id-03', 'column-id-04'], // sort order / position of Columns in boards
    columns: [
      {
        _id: 'column-id-01',
        boardId: 'board-id-01',
        ...
        cards: [
          {
            ...
            cover: 'https://img.freepik.com/free-vector/bokeh-defocused-background_23-2148497833.jpg',
          ...
          { _id: 'card-id-05', boardId: 'board-id-01', columnId: 'column-id-01', title: 'Title of card 05', description: null, cover: null, memberIds: ['test-user-id-01', 'test-user-id-02'], comments: ['test comment 01', 'test comment 02'], attachments: [] },
          { _id: 'card-id-06', boardId: 'board-id-01', columnId: 'column-id-01', title: 'Title of card 06', description: null, cover: null, memberIds: ['test-user-id-01'], comments: [], attachments: [] },
      ...
      },
      {
        ...
        cards: [
          ...
          { _id: 'card-id-09', boardId: 'board-id-01', columnId: 'column-id-02', title: 'Title of card 09', description: null, cover: null, memberIds: ['test-user-id-01'], comments: ['test comment 01', 'test comment 02'], attachments: [] },
